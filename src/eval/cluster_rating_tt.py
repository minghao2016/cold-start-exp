...
class RatingCluster:
    ...
    def __init__(self, train_file, test_file, genome, movies):
...
def main():
    ...
    for count, (train_n, test_n) in enumerate(zip(train_files, test_files)):
        ...
        rating_cluster = RatingCluster(train_n, test_n, genome, movies)
